...
add_menu_page( 'EUH Video Gallery Settings', 'EUH Video Gallery Settings', 'manage_options', 'wp10test/euhyoutubesettingsgeneral.php', array( $this , 'wp10settingscallback') , 'dashicons-youtube', 250  );

add_submenu_page( 'wp10test/euhyoutubesettingsgeneral.php', 'Sub 1', 'EUH Video Importer', 'manage_options', 'wp10test/euhyoutubeimporter.php', array( $this , 'wp10importercall' ));
